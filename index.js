...
document.getElementById('form').addEventListener('submit', function(event) {
   ...
   // Se a validação passar, você pode prosseguir com a autenticação
   // Por exemplo, fazer uma chamada ao backend para verificar o login

   // Aqui pode chamar uma função para autenticar o usuário, como:
